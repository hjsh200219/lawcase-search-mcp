...
export function createTradeEntityHandler(
  ...
  return createDispatcher<TradeEntityParams>("trade_entity", {
    ...
    search_animal_plant_company: async (p) => {
