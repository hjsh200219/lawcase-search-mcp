...
export function createShippingLogisticsHandler(
  ...
  return createDispatcher<ShippingParams>("shipping_logistics", {
    ...
    unloading_declarations: async (p) => {
