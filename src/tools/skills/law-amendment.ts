...
export function createLawAmendmentHandler(lawApiOc: string) {
  return createDispatcher<LawAmendmentParams>("law_amendment", {
    ...
    get_old_new_law_detail: async (p) => {
    ...
    get_three_way_comp_detail: async (p) => {
    ...
    search_law_change_history: async (p) => {
    ...
    search_admin_rule_old_new: async (p) => {
    ...
    get_admin_rule_old_new_detail: async (p) => {
